...
class SimpleWaypointFollowingLocalPlanner(LocalPlanner):
    ...
    def run_in_series(self, action) -> VehicleControl:
        """
        ...
        control: VehicleControl = self.controller.run_in_series(next_waypoint=target_waypoint, close_waypoint=close_waypoint, far_waypoint=far_waypoint, action=action)
        # self.logger.debug(f"\n"
